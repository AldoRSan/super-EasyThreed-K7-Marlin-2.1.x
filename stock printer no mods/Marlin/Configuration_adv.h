...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           300  // 5 min antes de apagar nozzle por seguridad
  #define FILAMENT_CHANGE_ALERT_BEEPS          10  
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT            // Mantener motores encendidos
...
//#if ENABLED(CUSTOM_USER_BUTTONS)
 ...
 //#if PIN_EXISTS(BUTTON5)
   ...
   //#define BUTTON5_WHEN_PRINTING false      // Enable button during printing
   //#define BUTTON5_GCODE         "G28"   
   //#define BUTTON5_DESC          "Home"  
 //#endif
//#endif
